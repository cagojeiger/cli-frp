...
from .exceptions import BinaryNotFoundError, ConnectionError, AuthenticationError, ProcessError
...
class FRPClient:
        ...
        try:
            ...
            if not self._process_manager.wait_for_startup():
                ...
                if not self._process_manager.is_running():
                    raise ConnectionError("Failed to connect to server - connection refused or server unreachable")
                else:
                    raise AuthenticationError("Authentication failed or server unreachable")
    ...
    def is_connected(self) -> bool:
        ...
        return self._connected and (
            self._process_manager is not None and 
