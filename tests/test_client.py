...
class TestFRPClient:
    ...
    @patch('frp_wrapper.client.ProcessManager')
    @patch('frp_wrapper.client.ConfigBuilder')
    def test_client_connect_when_already_connected(self, mock_config_builder, mock_process_manager, mock_find_binary):
    ...
    @patch('frp_wrapper.client.ProcessManager')
    @patch('frp_wrapper.client.ConfigBuilder')
    def test_client_handles_process_start_failure(self, mock_config_builder, mock_process_manager, mock_find_binary):
    ...
    @patch('frp_wrapper.client.FRPClient.find_frp_binary')
    @patch('frp_wrapper.client.ProcessManager')
    def test_client_disconnect_handles_exception(self, mock_process_manager, mock_find_binary):
    ...
    @patch('frp_wrapper.client.FRPClient.find_frp_binary')
    def test_client_context_manager_handles_disconnect_exception(self, mock_find_binary):
...
class TestFRPClientIntegration:
    ...
    @pytest.mark.skipif(not os.path.exists("/usr/local/bin/frpc"), reason="FRP binary not available")
